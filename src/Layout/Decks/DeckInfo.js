...
const DeckInfo = ({ deck, decks, setDecks }) => {
  //this will make the delete button work
  async function handleDelete() {
    ...
    if (
      ...
      await deleteDeck(id);
      const stillWantedDecks = decks.filter((deck) => deck.id !== id);
      setDecks(stillWantedDecks);
    }
  }

  return (
    // this will build the deck to see whats in/on it
